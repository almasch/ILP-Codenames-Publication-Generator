...
def allow_noise(ctx):
    """
    Generates Aleph experiments with allowed noise.
    """
    relation = ["HAS_HYPERNYM", "HAS_COMPONENT_HOLONYM", "HAS_MEMBER_HOLONYM", "HAS_PORTION_HOLONYM", "IS_RELATED_TO"]

    #create the output folder
    sub_folder_path = f"{ctx.aleph_experiments_dir}/{ctx.exp_noise_dir}"
    ...
    for seed in read_seeds_from_file(ctx.seeds_file):
        ...
        copy_template_files(seed_folder, "allow_noise")
